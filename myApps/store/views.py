...
class MarketListView(ListView):
    model = Market
    template_name = f'{base_url}/market/market_list.html'
...
class MarketCreateView(CreateView):
    ...
    template_name = f'{base_url}/market/market_form.html'
...
class MarketDeleteView(DeleteView):
    model = Market
    template_name = f'{base_url}/market/market_confirm_delete.html'
    success_url = reverse_lazy('market_list')

# Salesman Views
class SalesmanListView(ListView):
    model = Salesman
    template_name = f'{base_url}/salesman/salesman_list.html'
...
class SalesmanCreateView(CreateView):
    ...
    template_name = f'{base_url}/salesman/salesman_form.html'
    success_url = reverse_lazy('market_list')
...
class SalesmanDeleteView(DeleteView):
    model = Salesman
    template_name = f'{base_url}/salesman/salesman_confirm_delete.html'
    success_url = reverse_lazy('market_list')

# Product Views
class ProductListView(ListView):
    model = Product
    template_name = f'{base_url}/product/product_list.html'
...
class ProductCreateView(CreateView):
    ...
    template_name = f'{base_url}/product/product_form.html'
...
class ProductDeleteView(DeleteView):
    model = Product
    template_name = f'{base_url}/product/product_confirm_delete.html'
    success_url = reverse_lazy('product_list')

# Customer Views
class CustomerListView(ListView):
    model = Customer
    template_name = f'{base_url}/customer/customer_list.html'
...
class CustomerCreateView(CreateView):
    ...
    template_name = f'{base_url}/customer/customer_form.html'
...
class CustomerDeleteView(DeleteView):
    model = Customer
    template_name = f'{base_url}/customer/customer_confirm_delete.html'
    success_url = reverse_lazy('customer_list')

# Order Views
class OrderListView(ListView):
    model = Order
    template_name = f'{base_url}/order/order_list.html'
...
class OrderCreateView(CreateView):
    ...
    template_name = f'{base_url}/order/order_form.html'
...
class OrderDeleteView(DeleteView):
    model = Order
    template_name = f'{base_url}/order/order_confirm_delete.html'
    success_url = reverse_lazy('order_list')
...
class OrderItemCreateView(CreateView):
    ...
    template_name = f'{base_url}/orderitem/orderitem_form.html'
    success_url = reverse_lazy('product_list')
...
class OrderItemDeleteView(DeleteView):
    model = OrderItem
    template_name = f'{base_url}/orderitem/orderitem_confirm_delete.html'
    success_url = reverse_lazy('product_list')
